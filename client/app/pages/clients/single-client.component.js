...
var SingleClientComponent = (function () {
    function SingleClientComponent(route, router, clientService) {
        this.route = route;
        this.router = router;
        this.clientService = clientService;
        this.clientId = "Test client"; //testing purpose only
    }
...
exports.SingleClientComponent = SingleClientComponent;
//# sourceMappingURL=single-client.component.js.map